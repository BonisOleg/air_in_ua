    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.CharField(blank=True, help_text='Наприклад: img/service.png', max_length=255, null=True, verbose_name='Шлях до зображення')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image_url', models.URLField(blank=True, help_text='URL зображення з Cloudinary або іншого хмарного сервісу', max_length=500, null=True, verbose_name='URL зображення')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_method', models.CharField(choices=[('telegram', 'Telegram'), ('viber', 'Viber'), ('call', 'Подзвонити')], max_length=10, verbose_name="Спосіб зв'язку")),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Дата створення')),
                ('product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='feedbacks', to='airinua.product', verbose_name='Товар')),
            ],
            options={
